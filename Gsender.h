...
class Gsender
{
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN = "eTFrbWl0bG1lZC5hcmR1aW5vQGdtYWlsLmNvbQ0K";
        const char* EMAILBASE64_PASSWORD = "a21pdGx5MW1lZA0K";
        const char* FROM = "y1kmitlmed.arduino@gmail.com";
